        ...
        if (preg_match('/([а-яёА-ЯЁ]{1,})\w*([а-яёА-ЯЁ]{1,})/u', $word))
            if (mb_strlen($word, 'UTF-8') > 3)
                if (!preg_match('/(\d{1,})\w*(\d{1,})/u', $word))
                    if (preg_match('/[aceonpxuyABCEHKMOPTXYαβγδεζηθιΧΥѝκλμνξοπρσςτυφχψωқҗҳңҡҝҵҷҹӂӄӆӈӊӌӎӝӟӡӣӥӭӵӷӹӻӽӿӷӻґѓғṙṛṝṟᾐᾑᾒᾓᾔᾕᾖᾗῂῃῄῆῇἠἡἢἣἤἥἦἧὴήḣḥḧḩḫĥħϺΜϻḿṁṃṕṗҏṙṛṝṟṡṣṥṧṩṫṭṯṱẗàáâãäåāăąȁȃǎǟǡǻȧẚạảấầẩẫậắằẳẵặἀἁἂἃἄἅἆἇᾰᾱᾲᾳᾴάαᾶᾷᾀᾁᾂᾃᾄᾅᾆᾇὰάḁӑӓɑᴀѐèéêëēĕėęěȅȇȩẹẻẽếềểễệөӫḕḗḙḛḝҽҿӗùúûüǔǖǘǚǜȕȗũūŭůűųưʋὺύụủứừửữựῠῡῢΰῦῧὐὑὒὓὔὕὖὗṳṵṷṹṻòóôõöøōŏőɵơȍȏǒǿȫȭȯǫǭȱṍṏṑṓὀὁὂὃὄὅọỏốồổỗộớờởỡợӧοσόὸόýÿƴɏŷȳỳỵỷỹӯӱӳẙẏўүұṅṇṉṋǹćĉċčçƈͼϲҫҁϾϹҭkⱪķĸǩḱḳḵқҝҟҡќӄκƙҗҗӝӂxẋẍҳӽӿᴄᴏᴛℂ০קϿϷ϶ϰϭϬϗϓΤϒϏϐĘ]/u', $word))
